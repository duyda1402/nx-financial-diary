/**
 * Every error thrown in the SDK is an instance of 'DomiError'. The value of the 'code' property is eligible to
 ...
 */
abstract class DomiError extends Error {
  code: string;
  cause?: Error;
  ...
  protected constructor(message: string, code: string, cause?: Error) {
     ...
     */
    this.cause = cause;
    Object.setPrototypeOf(this, DomiError.prototype);
  }
}
 ...
 * @extends {NfdError}
 */
class TechnicalError extends DomiError {
  // eslint-disable-next-line require-jsdoc
 ...
 * @extends {DomiError}
 */
class NotFoundError extends DomiError {
  // eslint-disable-next-line require-jsdoc
  constructor(cause?: Error) {
 ...
 * @extends {DomiError}
 */
class ConflictError extends DomiError {
  // eslint-disable-next-line require-jsdoc
 ...
 * @extends {DomiError}
 */
class UnauthorizedError extends DomiError {
  // eslint-disable-next-line require-jsdoc
  constructor(cause?: Error) {
 ...
 * @extends {DomiError}
 */
class ForbiddenError extends DomiError {
  // eslint-disable-next-line require-jsdoc
  constructor(cause?: Error) {
...
export { DomiError, TechnicalError, ConflictError, NotFoundError, UnauthorizedError, ForbiddenError };
